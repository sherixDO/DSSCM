...
<div class="content">
  <div class="container-fluid">
    <nav class="pull-left">
      <strong>当前位置:</strong>&nbsp;&nbsp;&nbsp; <span>新闻管理 &gt; 修改新闻</span>
    </nav>
  </div>

  <div class="card container-fluid">
    <div class="header">
      <h4 class="title">修改新闻 <small>Modify News</small></h4>
    </div>
    <div class="content">
      <form id="newsForm" name="newsForm" method="post" action="${pageContext.request.contextPath}/sys/news/modifysave.html">
